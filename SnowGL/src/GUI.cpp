	...
	void GUI::onUpdate()
	{
		...
		if (!m_state->isUIHidden)
		{
			...
			if (m_selectedParticleSystem != nullptr)
			{
				...
				static float colStartF4[4] = { colStart.x, colStart.y, colStart.z, colStart.w };
				ImGui::PushItemWidth(80);
				...
				static float colEndF4[4] = { colEnd.x, colEnd.y, colEnd.z, colEnd.w };
				ImGui::PushItemWidth(80);
				...
				static float colCollisionF4[4] = { colCollision.x, colCollision.y, colCollision.z, colCollision.w };
				ImGui::PushItemWidth(80);
				...
				ImGui::SliderFloat("Collision Multiplier", &m_selectedParticleSystem->getSettingsPtr()->collisionMultiplier, 1.0f, 1000.0f);
